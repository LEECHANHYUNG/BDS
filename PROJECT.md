...
- 현재 목표: 모노레포 골격 스택을 의사결정 기반으로 확정 완료(ADR-0004~0006). 다음은 `@bds/tokens`·`@bds/react` 첫 패키지를 실제로 추가하면서 보류 항목(번들러·exports·tsconfig·a11y 보강)을 트리거에 맞춰 결정.
- 관련 산출물: `CONTEXT.md`, `docs/adr/0001~0006`, `DESIGN.md`, `docs/research/monorepo-foundation.md`
