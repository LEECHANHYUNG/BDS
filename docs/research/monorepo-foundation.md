...
- **tsup — 사실상 유지보수 중단.** GitHub README에 _"not actively maintained anymore. Please consider using tsdown instead."_ 명시. 동작은 문제없고 다운로드는 여전히 크지만 **신규 권장에서 빠짐**. ([tsup GitHub](https://github.com/egoist/tsup))
